...
if (isset($_SESSION["ClientLog"]) && isset($_SESSION["Carrito"]) && count($_SESSION["Carrito"]) > 0 ) {
    ...
    $page = "
        <div class='form-floating mb-3'>
            <input type='text' class='form-control' id='txtNDoc' readonly value='". $_SESSION['ClientLog']['DNI'] ."'>
            <label for='txtNDoc'>N° Documento</label>
        </div>
        <div class='form-floating mb-3'>
            <input type='text' class='form-control' id='txtCliente' readonly value='". $_SESSION['ClientLog']['Persona'] ."'>
