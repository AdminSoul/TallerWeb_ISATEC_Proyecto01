...
if(isset($_SESSION["ClientLog"]) && isset($_POST["tipo"]) && isset($_POST["doc"]) && isset($_POST["cli"]) && isset($_POST["dir"])){
    ...
    if($_POST["tipo"] == "F" && strlen($_POST["doc"]) <> 11){
        ...
        $venta = new Venta();
        $rpt = json_decode($venta->Nuevo(1, $_SESSION["ClientLog"]["IdPersona"], $_POST["doc"], $_POST["tipo"], "CO", json_encode($_SESSION["Carrito"])), true);
